...
VAL_IMAGE_IDS = [
    "005","012","014","020","024","028","033","045","047","050","058","065",
    "067","068","073","076","079","091","092","094","099","100","107","117",
    "133","134","135","141","145","153","163","176","177","179","184","185",
    "188","189","193","195","201","219","220","228","232","238","241","244",
    "250","255","259","265","271","274","277","278","280","295","297","299",
    "303","310","315","317","324","330","334","346","350","351","354","359",
    "364","368","374","375","385","387","399"
]
...
class NucleusConfig(Config):
    ...
    STEPS_PER_EPOCH = (2779 - len(VAL_IMAGE_IDS)) // IMAGES_PER_GPU #2690
    ...
    POST_NMS_ROIS_TRAINING = 1024 #** training階段所生成的box數量
    POST_NMS_ROIS_INFERENCE = 3072 #** testing階段所生成的box數量

    # Non-max suppression threshold to filter RPN proposals.
    # You can increase this during training to generate more propsals.
    RPN_NMS_THRESHOLD = 0.7 #NMS第一階段篩選最後篩出的機率

    # How many anchors per image to use for RPN training
    RPN_TRAIN_ANCHORS_PER_IMAGE = 2048 #** 單張影像所生成的anchors於datagen中(data_gen階段)

    # Image mean (RGB)
    MEAN_PIXEL = np.array([217.810, 198.469, 217.692])
...
class NucleusDataset(utils.Dataset):
    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        self.add_class("nucleus", 1, "BC")
        self.add_class("nucleus", 2, "TC")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        mask_dir  = os.path.join(os.path.dirname(os.path.dirname(info['path'])), "BC")
        mask_dir2  = os.path.join(os.path.dirname(os.path.dirname(info['path'])), "TC")
