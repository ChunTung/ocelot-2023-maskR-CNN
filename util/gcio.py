...
class DataLoader:
    ...
    def __init__(self, cell_path, tissue_path):
        ...
        # pdb.set_trace()
        # Image.open('/home/xuan/Downloads/test/ocelot23algo-main/test/input/images/cell_patches/000.tif')
        # self.cell_patches = np.array(Image.open(cell_fpath[0]))
        # self.tissue_patches = np.array(Image.open(tissue_fpath[0]))

        self.cell_patches = imread(cell_fpath[0])
        self.tissue_patches = imread(tissue_fpath[0])
